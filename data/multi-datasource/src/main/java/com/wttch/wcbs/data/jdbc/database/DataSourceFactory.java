...
public class DataSourceFactory {
  ...
  public static DataSource createDataSource(
      String dataSourceKey, DataSourceProperties dataSourceProperty) {
  ...
  private static DataSource createBasicDataSource(DataSourceProperties dataSourceProperty) {
    try {
  ...
  private static DataSource createDruidDataSource(DataSourceProperties dataSourceProperty) {
  ...
  private static DataSource createHikariDataSource(DataSourceProperties dataSourceProperty) {
